    ...
    <div class="container">
        ...
        <div class="row mt-5 mb-5">
            <table class="table table-hover table-striped" >
                <caption class="table-head">LIST OF All Bookings</caption>
                <tr>
                    <th>
                        ID
                    </th>
                ...
                <tr>
                    ...
                    <td><%=b.getNumber()%></td>
                    <td><%=b.getFlightNo()%></td>
                    <td><%=b.getDate_Time()%></td>
                    <td><%=b.getTakeOff_Point()%></td>
                    <td><%=b.getDestination()%></td>
                    <td><%=b.getSeatNo()%></td>
                    <td><a href="edit.jsp?number=<%=b.getNumber()%>"><button class="btn-warning" name="button">Edit</button></a></td>
                    <td><a href="remove.jsp?number=<%=b.getNumber()%>"><button class="btn-danger" name="button">Delete</button></a></td>
                </tr>
                <%}%>
            </table>
