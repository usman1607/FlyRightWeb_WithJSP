            ...
            <table class="table table-hover table-striped" >
                ...
                <%
                    if(request.getMethod().equalsIgnoreCase("POST")) {
                        String takeOff_Point = request.getParameter("tatkeOff_Point");
                        String destination = request.getParameter("destination");
                        FlightRepository flightRepository = new FlightRepository();
                        List<Flight> flightList = flightRepository.findAvailableFlight(takeOff_Point, destination);
                        if(flightList == null) {
                            out.print("There is no Flight going from "+ takeOff_Point + " to " + destination +" available now.\n");
                            return;
                        }else
                ...
                <tr>
                    ...
                    <td><%=f.getPrice()%></td>
                    <td><a href="../Booking/bookflight.jsp?number=<%=f.getNumber()%>"><button class="btn-info" name="button">Book</button></a></td>
                </tr>
                <%}%>
                <%}%>
            </table>
